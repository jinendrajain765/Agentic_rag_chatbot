...
from langgraph_rag_backend import embeddings  # your existing HF embeddings
# ---- Step 1: Ingest your test PDF into a fresh thread ----
THREAD_ID = "eval_thread_1"
PDF_PATH = "MACHINE LEARNING(R20A0518).pdf" # your actual PDF filename

with open(PDF_PATH, "rb") as f:
    ingest_pdf(file_bytes=f.read(), thread_id=THREAD_ID, filename=PDF_PATH)

# ---- Step 2: Your test set (edit these to match your PDF) ----
test_questions = [
...
# ---- Step 3: Run each question through your REAL chatbot ----
answers = []
contexts = []
